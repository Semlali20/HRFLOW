...
@Component({
  ...
  styles: [`
    ...
    :host-context([data-theme="dark"]) .search-wrap{border-color:#2A2A2A !important}
    :host-context([data-theme="dark"]) .search-wrap input{color:#FFFFFF !important}
    :host-context([data-theme="dark"]) .search-wrap input::placeholder{color:#4A6080}
    ...
    :host-context([data-theme="dark"]) .td-file{color:#6B6B6B !important}
    :host-context([data-theme="dark"]) .chip-CONTRACT{background:#1E3A5F;color:#93C5FD}
    :host-context([data-theme="dark"]) .chip-IDENTITY{background:#2E1B5E;color:#C4B5FD}
    :host-context([data-theme="dark"]) .chip-DIPLOMA{background:#14291F;color:#6EE7B7}
    :host-context([data-theme="dark"]) .chip-MEDICAL{background:#3B1219;color:#FCA5A5}
    :host-context([data-theme="dark"]) .chip-PAYSLIP{background:#2D2210;color:#FCD34D}
    :host-context([data-theme="dark"]) .chip-EVALUATION{background:rgba(47,168,160,.15) !important;color:#5EEAD4}
    :host-context([data-theme="dark"]) .chip-OTHER{background:#1A1A1A !important;color:#A0A0A0 !important}
    :host-context([data-theme="dark"]) .chip-expired{background:#3B1219;color:#FCA5A5}
    ...
    :host-context([data-theme="dark"]) .f-input{background:#1A1A1A !important;border-color:#2A2A2A !important;color:#FFFFFF !important;color-scheme:dark}
    ...
    :host-context([data-theme="dark"]) .alert-banner{background:#2D2210;border-color:#92400E;color:#FDE68A}
